...
BoundingBox BoundingBox::create(const pcl::PointCloud<pcl::PointXYZ>::ConstPtr& cloud,
...
BoundingBox BoundingBox::create(const pcl::PointCloud<pcl::PointXYZ>::VectorType& points,
                                const Eigen::Vector3f& normal)
{
